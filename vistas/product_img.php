...
<div class="container pb-6 pt-6">
	...
	<div class="columns">
		<div class="column is-two-fifths">
			<?php if(is_file("././assets/img/producto/".$datos['producto_foto'])){ ?>
			<figure class="image mb-6">
			  	<img src="././assets/img/producto/<?php echo $datos['producto_foto']; ?>">
			</figure>
			<form class="FormularioAjax" action="./controladores/producto_img_eliminar.php" method="POST" autocomplete="off" >
		...
		<div class="column">
			<form class="mb-6 has-text-centered FormularioAjax" action="./controladores/producto_img_actualizar.php" method="POST" enctype="multipart/form-data" autocomplete="off" >
	...
	<?php 
			...
			include "./empresa/error_alert.php";
		}
		$check_producto=null;
	?>
</div>